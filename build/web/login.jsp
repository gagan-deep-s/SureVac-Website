<%-- 
    Document   : login.jsp
    Created on : 18 Aug, 2018, 6:11:29 PM
    Author     : Hari Priya
--%>
...
<html>
        ...
        <div style="background-color:rgba(0,0,0,0.5);padding:30px;">
            ...
            <div style="float:right" class="menu" id="menus">
                <ul>
                    ...
                    <a href="login.jsp"><li class="active"><i class="fa fa-user"><b style="font-family:Comic Sans MS"> Login</b></i></li></</a>
    ...
    <center> <div class="log" style="background-color:rgba(0,0,0,0.5);box-shadow:5px 10px; width:500px;height:300px;margin-top:100px;"><div style="height:50px;background-color:rgba(0,0,0,0.5);font-size:25px;font-family:Cooper;color:white;">Login</div><div style="margin-top:50px">
